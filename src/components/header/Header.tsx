    ...
    >
      <div className="flex justify-between items-center px-4">
        <div className="flex  items-center">
          <Image src={logo1} alt="ShopTracker Logo" width={45} />
        ...
        <ul
          style={{ fontFamily: "Inter, sans-serif" }}
          className={
            "hidden md:flex space-x-10 font-bold text-[19px] list-none"
          }
        >
          <li>Footfall </li>
          <li>Promotions</li>
          ...
          <div className="flex ">
            <div className=" md:hidden text-xl mt-2 pr-5 font-semibold">
                Menu
            </div>
        {user?.image ? (
          <Image
